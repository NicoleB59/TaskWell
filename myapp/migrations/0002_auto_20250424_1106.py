# Generated by Django 3.1.12 on 2025-04-24 10:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('water_intake', models.DecimalField(decimal_places=1, help_text='Water intake in liters', max_digits=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('regularuser', 'regularUser'), ('premiumuser', 'premiumUser'), ('healthcoach', 'healthCoach')], max_length=50)),
